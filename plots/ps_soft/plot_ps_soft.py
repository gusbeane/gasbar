...
def run():
    ...
    time_soft20, ps_soft20 = get_pattern_speed(phS2R35, 'lvl3-soft0.04')
    ...
    ax.plot(time_SMUGGLE20, savgol_filter(ps_SMUGGLE20, 81, 3), c=tb_c[1], label=r'SMUGGLE (soft=0.02, fiducial)')
    ax.plot(time_soft20, savgol_filter(ps_soft20, 81, 3), c=tb_c[2], label=r'SMUGGLE (soft=0.04)')
