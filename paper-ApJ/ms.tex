...
2009ApJ...707..218V, 2010ApJ...719.1470V, 2014MNRAS.438L..81A}. However, we are
the first to demonstrate that the behavior ought to be present in a large
fraction of galaxies, since it occurs in our simulation with gas fractions as
low as about $5\%$. We are also the first to provide a physical explanation of
...
This halo exhaustion is similar to an effect called ``metastability'' discussed
in the literature \citep{2003MNRAS.345..406V, 2006ApJ...639..868S}. We note,
however, that metastability is a numerical effect arising from low resolution
and a poor sampling of resonances, and is not expected to occur in the real
universe.
