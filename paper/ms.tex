...
\begin{abstract}
  ...
  provided the expectation that, due to the interaction between the bar and
  the dark matter halo, the bar pattern will slow its rotation over time
  ...
  previous simulations but its explanation has remained
  ...
  the bar pattern and prevent it from slowing down or speeding up. This result
  naturally explains why nearly all observed bars rotate
  quickly\cite{2011MSAIS..18...23C, 2015AA...576A.102A, 2019MNRAS.482.1733G}
  and is especially relevant for our understanding of how the Milky Way
  arrived at its present day state.
...
1985MNRAS.213..451W} A stellar disk in isolation seems to always generate a
bar instability,\cite{1971ApJ...168..343H} but the presence of a strong
spherical potential (e.g., from a stellar bulge or dark matter halo) acts to
stabilize the disk against the bar instability.\cite{1973ApJ...186..467O,
1976AJ.....81...30H} A number of numerical simulations have confirmed that a
live dark matter halo generically exerts a negative torque on the bar, causing
...
in the dark matter halo in a manner similar to dynamical friction. This wake
lags and thus exerts a negative torque on the bar.

The preeminent expectation that the dark matter halo acts to slow the bar down
conflicts with observational estimates of bar pattern speeds. Bar rotation
...
Thus, numerical work has shown that the gas phase has an outsized influence on
the bar.\cite{2010ApJ...719.1470V, 2013MNRAS.429.1949A}
...
medium. The details of this experiment is given in the Methods section.
...
this test in which we varied the gas mass of the disk is given in the Methods
section.
