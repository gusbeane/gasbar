...
\keywords{Milky Way Galaxy (1054) --- Milky Way evolution (1052) --- Milky Way dynamics (1051) --- Galaxy dynamics (591) --- Hydrodynamical simulations (767) --- Barred spiral galaxies (136)}
...
In particular, we find that the presence of a significant gas phase in a
...
\begin{figure}
    ...
    \SMUGGLE{} case, indicating {\bf mass redistribution without a change in patttern speed}. The bar strength, shown in
...
$20\,\textrm{pc}$ for all collisionless components. This softening length
...
\begin{figure}
    ...
    \caption{The mass fraction within two disk scale lengths
...
\citet{2013MNRAS.429.1949A, 2014MNRAS.438L..81A} find stable evolution in
