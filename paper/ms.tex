...
\begin{abstract}
  ...
  provided the expectation that, due to the interaction between the bar and the halo, the bar pattern
  ...
  which includes a state-of-the-art model of the interstellar medium and a live dark matter halo. Here we
