...
mov_gasxy = 'movies-hose/' + name + '_gas_xy.mp4'
mov_gasxz = 'movies-hose/' + name + '_gas_xz.mp4'
mov_starxy = 'movies-hose/' + name + '_star_xy.mp4'
mov_starxz = 'movies-hose/' + name + '_star_xz.mp4'
mov_4panel = 'movies-hose/' + name + '_4panel.mp4'
...
if os.path.exists('movies-hose/' + name + '_4panel.mp4'):
    os.remove('movies-hose/' + name + '_4panel.mp4')
