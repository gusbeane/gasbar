...
def _torque_one_snap(path, prefix_in_bar, prefix_phase_space, name, nchunk, snap_idx, orig_idx, rot,
    ...
    for i in range(nchunk):
        if 'Nbody' in name:
            ...
            fname_in_bar = prefix_in_bar + 'in_bar_' + 'phantom-vacuum-Sg20-Rc3.5-lvl3' + '.' + str(i) + '.hdf5'
        ...
        bar_id.append(h5_in_bar['id_list'][in_bar_idx])

        h5_in_bar.close()

    bar_id = np.concatenate(bar_id)
...
def run(path, name, nproc, nsnap, rot, basepath = '/n/home01/abeane/starbar/analysis/bar_orbits/data/'):
    if 'Nbody' in name:
        prefix_in_bar = '../in_bar/data/in_bar_' + 'Nbody-lvl3' + '/'
        prefix_phase_space = '/n/home01/abeane/starbar/analysis/phase_space/data/' + 'Nbody-lvl3' + '/'
    else:
        prefix_in_bar = '../in_bar/data/in_bar_' + 'phantom-vacuum-Sg20-Rc3.5-lvl3' + '/'
        prefix_phase_space = '/n/home01/abeane/starbar/analysis/phase_space/data/' + 'phantom-vacuum-Sg20-Rc3.5-lvl3' + '/'
    ...
    if 'Nbody' in name:
        ...
        nchunk = len(glob.glob(prefix_in_bar+'/in_bar_'+'phantom-vacuum-Sg20-Rc3.5-lvl3'+'.*.hdf5'))
...
if __name__ == '__main__':
    ...
    Nbody = 'Nbody-fixedps'
    phgvS2Rc35 = 'phantom-vacuum-Sg20-Rc3.5-fixedps'

    pair_list = [(Nbody, 'lvl3-ps30', 30), # 0
                 (Nbody, 'lvl3-ps32', 32), # 1
                 (Nbody, 'lvl3-ps34', 34), # 2
                 (Nbody, 'lvl3-ps36', 36), # 3
                 (Nbody, 'lvl3-ps38', 38), # 4
                 (Nbody, 'lvl3-ps40', 40), # 5
                 (Nbody, 'lvl3-ps42', 42), # 6
                 (Nbody, 'lvl3-ps44', 44), # 7
                 (Nbody, 'lvl3-ps46', 46), # 8
                 (Nbody, 'lvl3-ps48', 48), # 9
                 (Nbody, 'lvl3-ps50', 50), # 10

                 (phgvS2Rc35, 'lvl3-ps30', 30), # 11
                 (phgvS2Rc35, 'lvl3-ps32', 32), # 12
                 (phgvS2Rc35, 'lvl3-ps34', 34), # 13
                 (phgvS2Rc35, 'lvl3-ps36', 36), # 14
                 (phgvS2Rc35, 'lvl3-ps38', 38), # 15
                 (phgvS2Rc35, 'lvl3-ps40', 40), # 16
                 (phgvS2Rc35, 'lvl3-ps42', 42), # 17
                 (phgvS2Rc35, 'lvl3-ps44', 44), # 18
                 (phgvS2Rc35, 'lvl3-ps46', 46), # 19
                 (phgvS2Rc35, 'lvl3-ps48', 48), # 20
                 (phgvS2Rc35, 'lvl3-ps50', 50),] # 21
